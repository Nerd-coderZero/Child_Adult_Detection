...
def main():
    ...
    try:
        ...
        print("1. Ensure 'best_model.pth' exists and is properly formatted")
        print("2. Check video file path and format")
        print("3. Verify system has required GPU/CPU resources")
        print("4. Check all required packages are installed")
